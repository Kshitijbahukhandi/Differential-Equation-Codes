...
% using the Backward Euler Method on a Variable Mesh
%
...
%
% Numerical Method:
%     Backward Euler Method with Variable Mesh
%
% Language:
%     MATLAB
%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  N=10; 
  ETA=1.2;
  disp('Variable Mesh Numerical Solution for the system of IVPs Using Backward Euler Method');
  disp('    ');
  fprintf('N=%4.2f\n',N);
  disp('  ');
  for I=1:8
