...
% using the Two-Step Nyström Method
%
% Numerical Method:
%     Two-Step Nyström Multistep Method
%
% Problem Type:
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 ...
 for I=1:8
    H=1.0/N;
    disp('Num sol of IVP using 2 step Nystrom Method');
    fprintf('N=4.2f\n',N);
    disp(' ')
 ...
 %intial comditions
    ...
    U(1)=1.0;
    tic
 %solution at t=h by the help of second order nystrom rk method
    K1=-2*H*T(1)*U(1)*U(1);
